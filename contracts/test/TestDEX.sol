...
interface ITestDEX {
    function swap(address _fromToken, uint256 _inputAmount, address _toToken) external;
}

contract TestDEX is ITestDEX {
    uint256 public constant price = 2;

    function swap(address _fromToken, uint256 _inputAmount, address _toToken) external override {
